...
const LogForm: React.FC<LogFormProps> = ({ initialData, onSubmit, onCancel }) => {
  ...
  return (
    <div className="relative w-full max-w-2xl bg-white md:rounded-2xl shadow-2xl h-[95vh] md:h-auto md:max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div className="col-span-2 space-y-1">
              <label className="text-[9px] font-black text-slate-400 uppercase">Maps Link</label>
              <input type="text" value={formData.mapLink} onChange={(e) => handleChange('mapLink', e.target.value)} placeholder="https://maps.google.com/..." className="w-full px-3 py-2 bg-slate-50 border border-slate-100 rounded-lg text-xs font-bold text-slate-600" />
            </div>
            <div className="col-span-2 space-y-1">
              <label className="text-[9px] font-black text-slate-400 uppercase">Website Link</label>
              <input type="text" value={formData.websiteLink} onChange={(e) => handleChange('websiteLink', e.target.value)} placeholder="https://www.business.com" className="w-full px-3 py-2 bg-slate-50 border border-slate-100 rounded-lg text-xs font-bold text-slate-600" />
            </div>
