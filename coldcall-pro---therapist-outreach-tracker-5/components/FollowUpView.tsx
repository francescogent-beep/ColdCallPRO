  ...
  return (
    <div className="space-y-12">
      <div className="flex justify-between items-center border-b border-slate-200 pb-6 bg-white p-5 rounded-xl shadow-sm">
        <div>
          <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tighter">Pipeline</h2>
          <p className="text-slate-400 text-[11px] font-black uppercase tracking-widest mt-1">Smart scheduling & tasks</p>
        </div>
        <div className="flex gap-3">
          <div className="bg-indigo-600 px-4 py-2 rounded-xl text-white text-center shadow-lg shadow-indigo-100">
            <div className="text-[9px] font-black uppercase opacity-70 leading-none mb-1">Active</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {priorityTasks.length === 0 && (
            <div className="col-span-full py-16 text-center bg-white border-2 border-dashed border-slate-200 rounded-2xl">
              <span className="text-[11px] font-black text-slate-400 uppercase tracking-widest leading-none">No immediate tasks</span>
            </div>
          )}
        </div>
      </section>

      <div className="border-t-4 border-slate-100 my-8"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {futureTasks.length === 0 && (
            <div className="col-span-full py-12 text-center bg-slate-50/50 border-2 border-dashed border-slate-100 rounded-2xl">
              <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest leading-none">Nothing on the horizon</span>
            </div>
          )}
        </div>
      </section>
